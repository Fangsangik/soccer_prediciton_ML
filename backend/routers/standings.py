...
async def get_standings(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to load standings") from exc
...
async def get_tournament(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to load tournament data") from exc
